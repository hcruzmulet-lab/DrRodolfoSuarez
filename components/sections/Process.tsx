...
export function Process() {
  return (
    <section id="proceso" style={{ position: "relative", background: "linear-gradient(180deg,rgba(11,37,69,.4),rgba(14,27,44,0))", scrollMarginTop: 90 }}>
      <div data-pad style={{ maxWidth: 1240, margin: "0 auto", padding: "90px 40px" }}>
        ...
        <div data-3col style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 22 }}>
          {process.map((p) => (
            <div key={p.n} style={{ position: "relative", padding: "34px 28px", border: "1px solid rgba(200,162,76,.16)", borderRadius: 18, background: "rgba(14,27,44,.5)" }}>
