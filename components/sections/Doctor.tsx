      ...
      <div data-doc style={{ display: "grid", gridTemplateColumns: ".9fr 1.1fr", gap: 60, alignItems: "center" }}>
        <div style={{ position: "relative" }}>
          ...
          <div style={{ position: "relative", borderRadius: 18, overflow: "hidden", aspectRatio: "5 / 6", background: "#0b2545", boxShadow: "0 30px 70px rgba(0,0,0,.5)" }}>
            ...
            <img src="/assets/dr-rodolfo-retrato.png" alt="Dr. Rodolfo Suárez, otorrinolaringólogo" style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "center 12%" }} />
          </div>
          <div style={{ position: "absolute", bottom: -26, right: -20, background: "#c8a24c", color: "#06111f", borderRadius: 14, padding: "16px 20px", boxShadow: "0 20px 40px rgba(200,162,76,.3)" }}>
            <div style={{ fontFamily: "var(--font-serif), 'Cormorant Garamond', serif", fontSize: 30, fontWeight: 700, lineHeight: 1 }}>15+</div>
        ...
        <div>
          ...
          <p style={{ fontSize: 16, lineHeight: 1.7, color: "rgba(233,237,245,.75)", margin: "0 0 18px" }}>
            Otorrinolaringólogo y cirujano con más de 15 años de trayectoria. Su enfoque combina la <strong style={{ color: "#f5f1e8", fontWeight: 600 }}>precisión médica</strong> con un trato humano y cercano: escuchar primero, explicar con claridad y tratar con la tecnología adecuada para cada caso.
          </p>
